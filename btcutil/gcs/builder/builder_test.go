...
import (
	...
	"github.com/HorizenOfficial/rosetta-zen/btcutil/gcs"
	"github.com/HorizenOfficial/rosetta-zen/btcutil/gcs/builder"
)
...
var (
	...
	testAddr = "znkCjSdK9gaSBMFHZuuxpsmgFFo4cXTqrNA"
...
func BuilderTest(b *builder.GCSBuilder, hash *chainhash.Hash, p uint8,
	outPoint wire.OutPoint, addrBytes []byte,
	t *testing.T) {

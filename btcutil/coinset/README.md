...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/HorizenOfficial/rosetta-zen/btcutil/coinset)
...
```bash
$ go get -u github.com/HorizenOfficial/rosetta-zen/btcutil/coinset
```

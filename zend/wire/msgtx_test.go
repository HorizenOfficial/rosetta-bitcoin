...
func TestTxHash(t *testing.T) {
	...
	txIn := TxIn{
		...
		SignatureScript: []byte{0x03, 0xd3, 0xbc, 0x01, 0x00, 0x5a, 0x2d, 0x4e, 0x4f, 0x4d, 0x50, 0x21, 0x20, 0x68, 0x74, 0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x6f, 0x73, 0x68, 0x75, 0x61, 0x79, 0x61, 0x62, 0x75, 0x74, 0x2f, 0x7a, 0x2d, 0x6e, 0x6f, 0x6d, 0x70}, // nolint
		Sequence:        0xffffffff,
	}
	txOut := TxOut{
		Value: 1143750000,
		PkScript: []byte{
			0x76, 0xa9, 0x14, 0x8e, 0x03, 0x7e, 0xaf, 0x85, 0x68, 0x18, 0x1b, 0x46, 0x00, 0x83,
			0x4b, 0x6a, 0x8d, 0xf4, 0xe1, 0xae, 0x04, 0x92, 0xbf, 0x88, 0xac,
		},
	}
	txOut2 := TxOut{
		Value: 106250000,
		PkScript: []byte{
			0xa9, 0x14, 0x50, 0x29, 0x50, 0x8c, 0xb3, 0xc3, 0x1c, 0xc2, 0x06, 0x58, 0x9e, 0x37,
			0x34, 0xaa, 0x53, 0x90, 0xf9, 0xac, 0x4c, 0x7e, 0x87,
		},
	}
	msgTx.AddTxIn(&txIn)
...
var multiTx = &MsgTx{
	...
	TxIn: []*TxIn{
		{
			...
			SignatureScript: []byte{0x03, 0xd3, 0xbc, 0x01, 0x00, 0x5a, 0x2d, 0x4e, 0x4f, 0x4d, 0x50, 0x21, 0x20,
				0x68, 0x74, 0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
				0x6d, 0x2f, 0x6a, 0x6f, 0x73, 0x68, 0x75, 0x61, 0x79, 0x61, 0x62, 0x75, 0x74, 0x2f, 0x7a, 0x2d, 0x6e,
				0x6f, 0x6d, 0x70},
			Sequence: 0xffffffff,
		},
	},
	TxOut: []*TxOut{
		...
		},
		{
			Value: 106250000,
			PkScript: []byte{
				0xa9, 0x14, 0x50, 0x29, 0x50, 0x8c, 0xb3, 0xc3, 0x1c, 0xc2, 0x06, 0x58, 0x9e, 0x37, 0x34,
				0xaa, 0x53, 0x90, 0xf9, 0xac, 0x4c, 0x7e, 0x87,
			},
		},
	},
	LockTime: 0,
...
var multiTxEncoded = []byte{
	...
	,
}
	...
	TxJoinsplit: []*Joinsplit{
		{
			Vpub_old: 1143740000,
			Vpub_new: 0,
			Anchor:   []byte{0xea, 0xd8, 0x3f, 0x30, 0x4d, 0x40, 0xf2, 0x5e, 0xda, 0xca, 0x59, 0x3c, 0x72, 0x56, 0x52, 0x22, 0x88, 0xd1, 0xa1, 0xe8, 0x21, 0xf4, 0x04, 0x37, 0x62, 0xca, 0x33, 0x09, 0xca, 0x86, 0x18, 0x6c}, // nolint
			Nullifiers: [][]byte{
				[]byte{0xb8, 0x22, 0x6b, 0x89, 0xdc, 0xf8, 0x07, 0x9e, 0xc7, 0x58, 0x5c, 0x12, 0x1f, 0xa3, 0x4f, 0x3b, 0x73, 0x84, 0xd6, 0xfa, 0x03, 0x51, 0x36, 0x41, 0x4e, 0x58, 0x6b, 0xa3, 0xc1, 0x40, 0x2f, 0x0e}, // nolint
				[]byte{0xcd, 0xe4, 0xf5, 0x35, 0xb6, 0x1a, 0x20, 0xe3, 0x18, 0xf1, 0xa8, 0x0a, 0x43, 0x6d, 0x64, 0x33, 0x29, 0x91, 0x8b, 0x90, 0x7f, 0xbe, 0x9d, 0x73, 0xfe, 0x31, 0x40, 0xc5, 0xb1, 0xe0, 0x38, 0xb9}, // nolint
			},
			Commitments: [][]byte{
				[]byte{0x23, 0x19, 0x5d, 0xcb, 0xdf, 0x48, 0x91, 0x5c, 0x5f, 0x2d, 0x55, 0x9a, 0x81, 0x54, 0xf1, 0x5b, 0x39, 0x6d, 0x96, 0xdb, 0xf5, 0x35, 0xc7, 0x2a, 0x26, 0x3a, 0x1d, 0xda, 0x28, 0x90, 0x13, 0xbd}, // nolint
				[]byte{0x6d, 0x7f, 0x54, 0x04, 0xca, 0xf7, 0x8e, 0x15, 0x3c, 0x04, 0x27, 0xf0, 0xc7, 0x76, 0xfd, 0x86, 0xbf, 0xac, 0xeb, 0x8a, 0x5f, 0x86, 0x0c, 0x4d, 0x5e, 0xda, 0x33, 0x5c, 0x6d, 0xdf, 0xc0, 0xbc}, // nolint
			},
			OneTimePubKey: []byte{0x58, 0xba, 0x26, 0xf9, 0x31, 0xa9, 0xf7, 0xe4, 0xdb, 0x19, 0x81, 0x02, 0xe5, 0x72, 0x8b, 0x79, 0x2b, 0x3c, 0x84, 0x63, 0x8b, 0x70, 0x80, 0x4a, 0x61, 0x78, 0x1a, 0x63, 0xb3, 0xa9, 0x01, 0xd3}, // nolint
			RandomSeed:    []byte{0xa0, 0x90, 0xa8, 0x64, 0x4b, 0x7a, 0xad, 0x47, 0x46, 0x87, 0xbf, 0x8f, 0x32, 0xfa, 0xae, 0xb2, 0x3a, 0x4b, 0xfa, 0x63, 0xdc, 0xbd, 0x60, 0x15, 0xe7, 0x8a, 0xb7, 0x03, 0xb0, 0xe8, 0xab, 0x57}, // nolint
			Macs: [][]byte{
				[]byte{0x51, 0xe4, 0x0a, 0xc1, 0x48, 0x1a, 0x08, 0x2b, 0x77, 0x84, 0x59, 0xab, 0x3f, 0xce, 0xf9, 0xd1, 0xc6, 0x70, 0x69, 0xac, 0xb3, 0x5e, 0xd1, 0xca, 0x40, 0x7a, 0x5b, 0x02, 0x05, 0x1a, 0xf3, 0x5c}, // nolint
				[]byte{0x17, 0xdf, 0x78, 0xc1, 0xe6, 0x20, 0xee, 0x5f, 0x07, 0xe2, 0x2a, 0x6a, 0xba, 0x7b, 0x9d, 0x6a, 0x29, 0xa7, 0xd2, 0x05, 0x61, 0xa6, 0x7e, 0xe2, 0x8b, 0xce, 0x7d, 0x08, 0x1a, 0x10, 0x6c, 0xbe}, // nolint
			},
			Proof: []byte{}, // nolint
			CipherText: [][]byte{
				[]byte{},
				[]byte{},
			},
			joinSplitPubKey: []byte{0x09, 0xcf, 0xa9, 0xac, 0xc0, 0x8e, 0xd4, 0x71, 0xe1, 0xc1, 0x88, 0xbb, 0x09, 0x58, 0xcb, 0xbc, 0x9c, 0x70,
				0x48, 0xc9, 0xe6, 0xcb, 0x73, 0x8e, 0x1e, 0x03, 0x69, 0x66, 0x23, 0x4e, 0xf3, 0x22},
			joinSplitSig: []byte{0x97, 0x78, 0x42, 0xd7, 0x46, 0xca, 0xba, 0x86, 0xcc, 0x24, 0x4d, 0xb0, 0x41, 0xac, 0x48, 0xc2, 0x24, 0x81,
				0x40, 0x36, 0x35, 0xc4, 0x8f, 0x55, 0xc2, 0x10, 0xa6, 0x30, 0x69, 0x7e, 0xc8, 0xec, 0x66, 0xb2, 0xa5, 0xf9, 0x44, 0xa3, 0x4c, 0x7d,
				0xf1, 0xd0, 0x72, 0x67, 0x58, 0xe1, 0x14, 0xe6, 0xdd, 0xd8, 0xd5, 0x40, 0x6d, 0x08, 0xfe, 0xa3, 0x03, 0x87, 0x30, 0xc1, 0x11, 0xbb, 0x2f, 0x04},
		},
	},
}

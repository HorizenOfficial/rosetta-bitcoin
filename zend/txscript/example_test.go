...
func ExamplePayToAddrScript_PayToPublicKey() {
	...
	address, err := zenutil.DecodeAddress(addressStr, &chaincfg.MainNetParams)
...
func ExampleSignTxOutput() {
	...
	pubKeyHash := zenutil.Hash160(pubKey.SerializeCompressed())
	addr, err := zenutil.NewAddressPubKeyHash(pubKeyHash,

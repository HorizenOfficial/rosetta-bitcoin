...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for https://github.com/HorizenOfficial/rosetta-zen
...
execute() {
  ...
  docker tag "rosetta-zen:${TAG}" "rosetta-zen:latest"
  log_info "loaded rosetta-zen:${TAG} and tagged as rosetta-zen:latest"
  rm -rf "${tmpdir}"

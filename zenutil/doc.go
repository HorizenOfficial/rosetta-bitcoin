...
A Block defines a horizen block that provides easier and more efficient
...
A Tx defines a horizen transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a Horizen address.  While the
most common type is a pay-to-pubkey-hash, horizen already supports others and
